 ...
 * Generated at: 2021-03-28 18:29:38 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/board/../footer.jsp", Long.valueOf(1616950140000L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t{{#each.}}\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>{{bnum}}</td>\r\n");
      out.write("\t\t\t\t<td>{{userID}}</td>\r\n");
      out.write("\t\t\t\t<td><a href='{{bnum}}' class=\"aSubject\">{{subject}}</a></td>\r\n");
      out.write("\t\t\t\t<td>{{readcount}}</td>\r\n");
      out.write("\t\t\t\t<td>{{goodcnt}}</td>\r\n");
      out.write("\t\t\t\t<td>{{nongoodcnt}}</td>\r\n");
      ...
      out.write("\t$(function() {\r\n");
      out.write("\t\t//조회,하이퍼링크 클릭했을때 처리할 함수\r\n");
      out.write("\t\tfunction pageList(curPage) { //현재페이지 매개변수로\r\n");
      out.write("\t\t\tconst findKey = frmList.findKey.value;\r\n");
      out.write("\t\t\tconst findValue = frmList.findValue.value;\r\n");
      ...
      out.write("\t\t\t\tdata:{findKey:findKey,findValue:findValue,curPage:curPage},\r\n");
      out.write("\t\t\t\tdataType:'json', //돌려받는 데이터 형태\r\n");
      ...
      out.write("\t\t            $('#boardList').html(template(result.blist));\t\t\r\n");
      out.write("\t\t            \r\n");
      out.write("\t\t            const pdto = result.pdto; //페이징 정보\r\n");
      out.write("\t\t            //페이징 처리\r\n");
      out.write("\t\t            $('.pagination').html(''); //초기화\r\n");
      out.write("\t\t            if (pdto.startPage != 1){\r\n");
      out.write("\t\t            \t$('.pagination').append('<li class=\"page-item\"><a class=\"page-link aPage\" href=\"'+(pdto.startPage-1)+'\">prev</a></li>');\r\n");
      out.write("\t\t            }\r\n");
      out.write("\t\t            for(var i=pdto.startPage; i<pdto.endPage+1; i++){\r\n");
      out.write("\t\t            \tif (pdto.curPage == i) //현재 페이지이라면 active\r\n");
      out.write("\t\t            \t\t$('.pagination').append('<li class=\"page-item active\"><a class=\"page-link aPage\" href=\"'+i+'\">' + i+'</a></li>');\r\n");
      out.write("\t\t            \telse\r\n");
      out.write("\t\t            \t\t$('.pagination').append('<li class=\"page-item\"><a class=\"page-link aPage\" href=\"'+i+'\">' + i+'</a></li>');\r\n");
      out.write("\t\t            }\r\n");
      out.write("\t\t            if (pdto.endPage < pdto.totPage){\r\n");
      out.write("\t\t            \t$('.pagination').append('<li class=\"page-item\"><a class=\"page-link aPage\" href=\"'+(pdto.endPage+1)+'\">next</a></li>');\r\n");
      out.write("\t\t            }\r\n");
      out.write("\r\n");
      out.write("\t\t            \t\r\n");
      out.write("\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//페이지 클릭시\r\n");
      out.write("\t\t\t$('.pagination').on('click','aPage', function(e) {\r\n");
      out.write("\t\t\t\te.preventDefault();\r\n");
      out.write("\t\t\t\tconst pageNo = $(this).attr('href');\r\n");
      out.write("\t\t\t\tpageList(pageNo);\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//게시글 추가폼으로 이동\r\n");
      ...
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//게시물의 제목(하이퍼 링크)를 클릭했을때\r\n");
      out.write("\t\t\t$('#boardList').on('click', '.aSubject', function(e) {\r\n");
      out.write("\t\t\t\te.preventDefault();\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tpageList(); //화면레 리스트+페이징 출력\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      ...
      out.write("\t\t<form name=\"frmList\" action=\"\">\r\n");
      ...
      out.write("\t\t\t\t<option value=\"subcon\">제목+내용</option>\r\n");
      out.write("\t\t\t</select>\r\n");
      out.write("\t\t<input type=\"text\" name=\"findValue\"> \r\n");
      out.write("\t\t<button id=\"btnList\">조회</button>\r\n");
      out.write("\t\t<button id=\"btnAdd\">게시글추가</button>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t<div id=\"boardList\"></div>\r\n");
      out.write("\t\t<ul class=\"pagination\"></ul> <!-- 페이징처리 --> \r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\r\n");
      out.write('\r');
